...
//          }
      ...
      // 获取数据
      val df = spark.read.parquet("/Users/guyujiajie/Documents/IDEAOutput/txt2ParquetOut/part-00000-0ca0441b-e8e7-4682-b924-f5d4664bf19c-c000.snappy.parquet")
